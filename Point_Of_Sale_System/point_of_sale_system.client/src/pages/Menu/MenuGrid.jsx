        ...
        {categories.map((category) => (
          <Nav.Item key={category.id}>
            <Nav.Link 
              ...
              style={{ 
                color: activeTab === category.id ? '#333' : '#666',
                fontWeight: '500',
                border: activeTab === category.id ? '2px solid #333' : '2px solid transparent',
                borderBottom: 'none',
                backgroundColor: activeTab === category.id ? 'white' : 'transparent'
              }}
            >
              {category.name}
            </Nav.Link>
